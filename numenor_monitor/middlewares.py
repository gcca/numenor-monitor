...
class RequestLogger:
    ...
    def log_request(
        ...
        Args:
            ...
            remote_addr (str): REMOTE_ADDR — direct TCP connection IP.
            x_forwarded_for (str): Raw X-Forwarded-For header value, or None.
            cf_connecting_ip (str): CF-Connecting-IP header value, or None.
